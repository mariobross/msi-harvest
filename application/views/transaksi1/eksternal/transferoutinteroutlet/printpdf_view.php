...
<table style="border-collapse:collapse;" width="709" border="1" align="center">
  <tr>
    ...
    <td width="34"><span class="style3 style5">Quantity</span></td>
    <td width="24"><span class="style3 style5">UOM</span></td>
    <td width="24"><span class="style3 style5">Check Out</span></td>
    <td width="25"><span class="style3 style5">Check In</span></td>
