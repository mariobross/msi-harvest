                                    ...
                                    <div class="col-md-12">
                                        <fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" readonly="" value="669">
												</div>
											</div>
											
											<div class="form-group row">
												<label class="col-lg-3 col-form-label">SR Number</label>
												<div class="col-lg-9"><input type="text" class="form-control" readonly="" value="10886">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" readonly="" value="15808">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" readonly="" value="16612">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" readonly="" value="WDFGCKST - Cikini">
												</div>
											</div>
		...
		<script>
            $(document).ready(function(){
                $('#tableWhole').DataTable({
                    ...
                    "ajax": {
                        "url":"<?php echo site_url('transaksi1/transferininteroutlet/showEditData');?>",
                        "type":"POST"
                    },
                    "columns": [
                        {"data":"no"},
						...
						{"data":"variance", "className":"dt-center", render:function(data, type, row, meta){
                            rr=`<input type="checkbox" class="form-control">`;
                            return rr;
                        }},
                    ]
                });
